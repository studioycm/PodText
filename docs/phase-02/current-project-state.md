...
| AUTHZ1 - Dynamic roles, grouped mini-abilities, and policy migration | Foundation/C implementation complete; independent C audit requires remediation before AUTHZ1-D planning; authority cutover not started | Foundation handoff; `docs/research/settings-performance/12-authz1-pre-implementation-research.md`; `13-authz1-foundation-research.md`; `15-authz1c-analyzer-backfill-*`; `16-authz1c-independent-analyzer-backfill-audit.md`; `docs/phase-02/authz1c-analyzer-backfill-handoff.md`; `docs/phase-02/authz1c-independent-analyzer-backfill-audit-handoff.md` | The reversible foundation and C implementation are shipped, but audit decision 2 found one High, four Medium, and two Low gaps requiring a separate C remediation prompt. Legacy enum/rank/Gates remain authoritative; D–I remain unstarted and the MySQL rehearsal remains a separate future gate. |
