...
| AUTHZ1 - Dynamic roles, grouped mini-abilities, and policy migration | Foundation and AUTHZ1-C implementation complete with green final gate; authority cutover not started; commit closeout pending | Foundation handoff; `docs/research/settings-performance/12-authz1-pre-implementation-research.md`; `13-authz1-foundation-research.md`; `15-authz1c-analyzer-backfill-*`; `docs/phase-02/authz1c-analyzer-backfill-handoff.md` | The exact reversible foundation is shipped. C adds raw fail-closed analysis, exact accepted-fingerprint role projection, post-commit cache/crash recovery, idempotency, parity, and receipt rollback. Legacy enum/rank/Gates remain authoritative; D–I remain unstarted and the MySQL rehearsal remains a separate future production gate. |
