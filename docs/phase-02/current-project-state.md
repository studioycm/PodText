...
| Step 5B - Card Template Admin Preview UX | Complete, including restricted selector, parts auto-refresh, expanded editor UX, UX2 position-canonical closure, FU01 strict image order, and O1 `lg` preview shell | `c75d0f2b2d476c58d12c16610ea97ba4088c5e79 feat: add focused card template preview`; `69813dbd4002ed8e7c3e42e640f7d48085e275da fix: guard restricted card preview samples`; `cdf0e89789c0c987abc0f577ea74d6c8303afa4b fix: refresh card preview from template parts`; `d889d4f6fca521616e148890502b038a113dff9c feat: refine card template editor ux`; UX2 `82e639d0fd22c06c52a70acec7c26ee9e2d8c72a`; FU01 `2d028255e416399d9b167b2ca9a091e2eec852f5`; research/plans 21–34; preview, UX2, strict-image-order, and `lg`-column handoffs; latest implemented audit `LS-20260719-STEP5B-CARD-RENDER-O1-LG-PREVIEW-SHELL-01`; option `STEP5B-CARD-RENDER-OVERHAUL-O1-LG-PREVIEW-SHELL` | Unsaved inert preview with a native slide-over below 1024px and one adjacent logical-end column at 1024px+, synchronized unmount/root/focus state, compact controls, public-safe samples, restricted no-query boundaries, browser-local Builder modes, position-canonical focused editing, native scoped movement, transient label/icon switches, and exact item/group image order. Global explicit-order compatibility remains unchanged. O2 renderer flow/Tailwind work, FU02 ranking, FU03 path targeting, FU04 order compatibility, FU05 interaction closure, FU06 copy cleanup, nested images, production normalization, persistence, migration, dependency, lifecycle, permission, generalized platform change, and next roadmap selection remain excluded. |
...
- Step 5B FU01 strict top-level item/group image ordering is complete. FU02
  sample ranking, FU03/O4 path-aware invalid-field navigation, nested image
  ...
  no production normalization is selected or prescribed. A fresh read-only
  Simplifier audit is requested after FU01, but no option is preselected.
