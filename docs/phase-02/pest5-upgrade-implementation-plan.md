...
- [ ] **Step 4: Record the pre-upgrade baseline facts** in the task report: `composer show --direct | grep pest`, `vendor/bin/pest --version`, and the last green full-gate numbers (2,001 / 20,951 / ~343s).
