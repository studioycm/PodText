...
**Written:** 2026-08-11 (Phase U session; research-verified against pestphp.com, Packagist, and GitHub the same day). **Status: EXECUTING — gate opened 2026-08-12 by the operator's direct answer** ("Yes — execute now", confirming the F13-conditional opening was real; the DP3/DP5/DP4/push stops inside the plan remain individually operator-gated).
