...
return [
    ...
    'empty' => [
        'contributor_items' => 'עדיין אין פריטים מפורסמים למתמלל הזה.',
        'contributor_preview' => 'בחרו מתמלל כדי לראות תצוגה מקדימה של פריטים מפורסמים קשורים.',
    ...
    'labels' => [
        ...
        'public_content_items_count' => '{0} אין פריטים|{1} פריט אחד|[2,*] :count פריטים',
    ...
    'pages' => [
        ...
        'contributor' => [
            'items_heading' => 'פריטים של המתמלל',
            'kicker' => 'מתמלל',
        ],
        'contributors' => [
            'description' => 'איתור מתמללים ותצוגה מקדימה של פרקים שמחוברים לתמלולים שפורסמו.',
            'kicker' => 'מתמללים',
            'preview_description' => 'תצוגה מהירה של פריטים שמחוברים דרך תמלולים שפורסמו.',
        ...
        'search' => [
            'description' => 'חיפוש בכל פריטי התוכן המפורסמים עם תמלולים שפורסמו.',
            'kicker' => 'חיפוש',
            'title' => 'חיפוש בתוכן',
        ],
        'tag' => [
    ...
    'results' => [
        ...
        'count' => '{0} אין פריטים|{1} פריט אחד|[2,*] :count פריטים',
        'public_contributors_only' => 'מוצגים מתמללים עם תמלולים שפורסמו בפריטים.',
