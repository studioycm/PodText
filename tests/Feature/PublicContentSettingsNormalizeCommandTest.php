...
it('keeps gated transcription policy bytes unchanged during anonymous normalize apply', function (): void {
    ...
    // insertion order (sebastian/comparator's default array comparison is
    // key-based, so list/part ORDER elsewhere stays enforced, only
    // associative key order is relaxed here).
