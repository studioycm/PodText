    ...
    >
        ...
        <aside @class([
            ...
            <div class="min-h-6" aria-live="polite" aria-atomic="true">
                <p x-cloak x-show="uploading" class="text-primary-700 dark:text-primary-300 text-xs">
                    {{ __('admin.media_library.upload_in_progress') }}
                </p>
                <p wire:loading class="text-primary-700 dark:text-primary-300 text-xs">
                    {{ __('admin.media_library.working') }}
                </p>
                <p wire:offline class="text-danger-700 dark:text-danger-300 text-xs">
                    {{ __('admin.media_library.offline') }}
                </p>
            </div>

            <fieldset data-testid="media-picker-source-form" wire:offline.attr="disabled">
