<div>
    <div class="mb-6 space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div class="grid gap-3 md:grid-cols-[1fr_auto_auto] md:items-end">
            @if ($pageConfig['search_enabled'] ?? true)
                <label class="grid min-w-0 gap-1 text-sm font-medium text-gray-700 dark:text-gray-200">
                    ...
                    <input
                        ...
                        class="focus:border-primary-500 focus:ring-primary-500 w-full rounded-lg border-gray-300 bg-white text-gray-950 shadow-sm dark:border-gray-700 dark:bg-gray-950 dark:text-white"
            ...
            <label class="grid gap-1 text-sm font-medium text-gray-700 dark:text-gray-200">
                ...
                <select
                    ...
                    class="focus:border-primary-500 focus:ring-primary-500 rounded-lg border-gray-300 bg-white text-gray-950 shadow-sm dark:border-gray-700 dark:bg-gray-950 dark:text-white"
                >
        ...
        @if (($pageConfig['category_filter_enabled'] ?? true) && $categoryOptions->isNotEmpty())
            <div class="space-y-2" data-test="podcast-category-filters">
                <p class="text-sm font-medium text-gray-700 dark:text-gray-200">{{ __('public.filters.category') }}</p>
    ...
    <div class="mb-4 flex flex-col gap-1 text-sm text-gray-600 sm:flex-row sm:items-center sm:justify-between dark:text-gray-300">
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('public.results.public_podcasts_only') }}</p>
    </div>
