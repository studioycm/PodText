<div>
    ...
    @if ($showControls)
        <div
            class="mb-4 space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900"
            data-test="group-item-controls"
        >
    ...
    @else
        ...
        @if ($items->hasPages())
            <div class="mt-6" data-test="group-item-pagination">{{ $items->links() }}</div>
        @endif
    @endif
</div>
