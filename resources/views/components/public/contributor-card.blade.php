...
@if($compact)
    ...
    >
        @foreach($card['body_parts'] as $part)
            <x-public.contributor-card-part :part="$part" :presentation="$presentation" :compact="true" />
        @endforeach
    </button>
@else
<article
...
>
    <div class="{{ $presentation['body'] }}">
        @foreach($card['body_parts'] as $part)
            <x-public.contributor-card-part :part="$part" :presentation="$presentation" :compact="false" />
        @endforeach
    </div>
