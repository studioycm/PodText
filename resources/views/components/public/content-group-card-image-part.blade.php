...
>
    ...
    @else
        <div
            class="flex h-full min-h-24 w-full items-center justify-center bg-gray-100 text-2xl font-semibold text-gray-500 dark:bg-gray-800 dark:text-gray-300"
            data-test="content-group-fallback"
        >
            {{ $part['image']['initials'] }}
        </div>
    @endif
