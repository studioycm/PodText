    ...
    <div class="space-y-8" dir="{{ __('public.meta.dir') }}">
        <div class="grid gap-6 md:grid-cols-[8rem_minmax(0,1fr)] md:items-start">
            @if ($pageImage['url'])
                ...
                >
                    <img src="{{ $pageImage['url'] }}" alt="" class="h-full w-full object-cover" />
                </span>
            @else
                <div
                    class="bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-100 flex aspect-square w-full items-center justify-center rounded-full text-4xl font-semibold ring-1 ring-gray-950/10 dark:ring-white/10"
                    data-test="contributor-page-fallback"
                >
                    {{ $initial }}
                </div>
            @endif
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-2">
                    <h1
                        class="text-3xl font-semibold tracking-normal text-gray-950 dark:text-white"
                        data-test="contributor-page-name"
                    >
                        {{ $author->name }}
                    </h1>
