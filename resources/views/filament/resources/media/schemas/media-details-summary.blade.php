<div class="space-y-4" data-testid="media-details-summary">
    ...
    @else
        <div
            class="rounded-xl border border-success-300 bg-success-50 p-4 text-sm font-medium text-success-900 dark:border-success-700 dark:bg-success-950 dark:text-success-100"
            role="status"
    ...
    <x-filament::section>
        ...
        <div class="grid min-w-0 gap-5 md:grid-cols-[minmax(0,14rem)_minmax(0,1fr)]">
            ...
            <div class="min-w-0">
                <h3 class="break-words text-lg font-semibold text-gray-950 dark:text-white">
                    {{ $summary['identity'] }}
                </h3>
