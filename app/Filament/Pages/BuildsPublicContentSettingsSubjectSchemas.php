...
trait BuildsPublicContentSettingsSubjectSchemas
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        foreach (SettingsSubjectOwnershipRegistry::validatorGroups($this->settingsSubject()) as $group) {
        ...
        return match ($this->settingsSubject()) {
            ...
            SettingsSubjectOwnershipRegistry::CARD_TEMPLATES => [
                ...$owned,
    ...
    protected function normalizeOwnedFormData(array $data, array $stored): array
    {
        ...
        $currentMaintenance = $stored['maintenance'] ?? PublicFrontConfigRegistry::defaults()['maintenance'];
